...
<body>
    <form id="form1" runat="server">
        <asp:Table ID="InitialDataTable" runat="server" Width="900px" GridLines="Both" CellPadding="5">
            <asp:TableRow runat="server">
                <asp:TableCell ID="TextInitialDataTable" runat="server" ColumnSpan="5">Padinių duomenų lentelė</asp:TableCell>
            </asp:TableRow>
            <asp:TableRow runat="server">
                <asp:TableCell runat="server">Vairtuotojo pavardė</asp:TableCell>
        ...
        <asp:Button ID="MakeListButton" OnClick="MakeList" runat="server" Text="Sudaryti mašinų sąrašą" />
        <hr />
